...
draft: false
summary: "We all know how frustrating it is to start working on an idea to later find that... in fact... that idea wasn't that great after all. What makes for a good business idea? How can you find one?"
---
...
![](https://focuskeep.com/favicon-32x32.png)FocusKeep

![](https://keepfocus.com/apple-touch-icon.png)
